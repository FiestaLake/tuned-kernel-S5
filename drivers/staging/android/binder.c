...
inline static void print_binder_transaction(struct seq_file *m, const char *prefix,
				     struct binder_transaction *t)
{
}

inline static void print_binder_buffer(struct seq_file *m, const char *prefix,
				struct binder_buffer *buffer)
{
}

inline static void print_binder_work(struct seq_file *m, const char *prefix,
			      const char *transaction_prefix,
			      struct binder_work *w)
{
}

inline static void print_binder_thread(struct seq_file *m,
				struct binder_thread *thread,
				int print_always)
{
}

inline static void print_binder_node(struct seq_file *m, struct binder_node *node)
{
}

inline static void print_binder_ref(struct seq_file *m, struct binder_ref *ref)
{
}
...
inline static int binder_state_show(struct seq_file *m, void *unused)
{
	return 0;
}
